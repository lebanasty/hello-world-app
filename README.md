...
- [Step-by-Step Deployment Guide](#step-by-step-deployment-guide)
  ...
  - [Step 2: Create the Amazon ECR Repository](#step-2-create-the-amazon-ecr-repository)
  - [Step 3: Create the S3 Bucket for Terraform State](#step-3-create-the-s3-bucket-for-terraform-state)
  - [Step 4: Configure Secrets and Environment Variables](#step-4-configure-secrets-and-environment-variables)
  - [Step 5: Build and Push the Docker Image to Amazon ECR](#step-5-build-and-push-the-docker-image-to-amazon-ecr)
  - [Step 6: Trigger the CI/CD Pipeline](#step-6-trigger-the-cicd-pipeline)
